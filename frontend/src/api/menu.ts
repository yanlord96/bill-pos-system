...
export const getMenuItem = (id: number) => api.get<MenuItem>(`/menu/${id}`).then((r) => r.data);
export const createMenuItem = (data: { name: string; category: MenuCategory; price: number; is_available?: boolean }) =>
